...
@InnerTestClasses({LazyResolveDescriptorRendererTestGenerated.Renderer.class, LazyResolveDescriptorRendererTestGenerated.Multifile.class})
public class LazyResolveDescriptorRendererTestGenerated extends AbstractLazyResolveDescriptorRendererTest {
    ...
    @TestMetadata("compiler/testData/lazyResolve/multifile")
    public static class Multifile extends AbstractLazyResolveDescriptorRendererTest {
        public void testAllFilesPresentInMultifile() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/lazyResolve/multifile"), Pattern.compile("^(.+)\\.resolve$"), true);
        }
        
        @TestMetadata("JavaAndKotlinSameName.resolve")
        public void testJavaAndKotlinSameName() throws Exception {
            doTest("compiler/testData/lazyResolve/multifile/JavaAndKotlinSameName.resolve");
        }
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(Multifile.class);
        return suite;
    }
}
